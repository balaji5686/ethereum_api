...
// Initialize Web3 connection using the INFURA_PROJECT_ID from the .env file
...
const contractAddress = '0x21104196FF04d95c8D4dD940f59726E00D3A08b9';
...
app.get('/balajiapitest', async(req, res) => {
    try {
        const address = '0xfAcAa6ACC887655e594f0c4DB761b1f7f00aeBbe';
        const balance = await contract.methods.balanceOf(address).call(); // Call balanceOf method

        console.log(`Balance for ${address}:`, balance);
        res.send({
            address: address,
            balance: web3.utils.fromWei(balance, 'ether') // Convert balance from Wei to Ether for readability
        });
    } catch (error) {
